...
export function SolutionSection() {
    ...
    const solutions = [
      { icon: "⚡", title: "現場レベルの問題でスキルが身につく", desc: "実務で実際に問われる観点・設計・実装を問題形式で体験。理解が「使える知識」に変わる。" },
      { icon: "🗺️", title: "何を勉強すべきか、迷わない", desc: "体系的なカリキュラムで学習順序を設計済み。今日やるべき問題が明確になる。" },
      { icon: "💪", title: "実務で使える力がつく", desc: "正答率グラフと復習機能で弱点を可視化。繰り返すことで確かな自信がつく。" },
    ];
